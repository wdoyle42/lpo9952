...
stata -b -q do ../do/lecture01_conditional_means.do
```
...
then calculate the mean squared error (which is exactly what it sounds 
...
end <- 'Above average(median) vs. below average'
...
```{r}
start <- 'Above average(median) vs. below average'
